...
"for grep_file.c get_flags.h Makefile FLAGS"
"for grep_file.c FLAGS"
"-e for -e ^int grep_file.c get_flags.h Makefile FLAGS"
"-e for -e ^int grep_file.c FLAGS"
"-e while -e void grep_file.c Makefile FLAGS -f test_files/test_ptrn_grep.txt"
